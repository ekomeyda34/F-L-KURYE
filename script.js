...
const updatePriceDisplay = (distanceKm) => {
    ...
    whatsappLink.href = `https://wa.me/905422827453?text=${encodeURIComponent(msg)}`;
};
...
// Numaralar
const phoneNum1 = "05422827453"; // Hat 1
const phoneNum2 = "05422827453"; // Hat 2 (Mevcut)

// Ülke kodu eklenmiş hali (WhatsApp için)
const waNum1 = "05422827453";
const waNum2 = "05422827453";
